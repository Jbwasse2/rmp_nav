...
gflags.DEFINE_boolean(
    "proximity_label", False, "True if model requires proximity labels"
)
gflags.DEFINE_boolean(
    "heading_diff_label", False, "True if model requires heading_diff labels"
)
...
gflags.DEFINE_string(
    "persistent_server_cfg", "../gibson_persistent_servers_cfg.yaml", ""
)
...
gflags.DEFINE_string(
    "set", "", "A comma separated assignment string that overwrites flag values."
)
